                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html"><i class="fa-solid fa-user-doctor"></i>
                                        Dosen Pembimbing
                                    </a>
                                    <a class="nav-link" href="layout-static.html"><i class="fa-solid fa-user-graduate"></i>
                                        Mahasiswa Profesi
                                    </a>
