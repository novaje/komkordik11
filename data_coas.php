    ...
    <body class="sb-nav-fixed">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $ambildata = mysqli_query($conn, "select * from kom_coas");
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-dark btn-xs">Detail</td></button>
                                            <td>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
            ...
            <div class="modal-dialog">
                ...
                <div>
                    <p>Nama Lengkap :</p>
                    <input type="comment" name="nama_lengkap" class="form-control">
                    <p>Kelompok :</p>
                    ...
                    <button type="submit" class="btn btn-primary" name="add_coas">Submit</button>
                    </div>
                </div>
                </form>
                </div>
