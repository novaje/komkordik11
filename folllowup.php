                    ...
                    <div class="container-fluid px-4">
                        ...
                        <!-- Button to Open the Modal -->
                            <div class="pull-right">
                                ...
                                <a href="add_dokter.php" class="btn btn-success btn-xs"><i class='fa fa-user-plus'></i><i class="glyphicon glyphycon-plus"></i>Tambah Jadwal Kegiatan</a>
                            </div>
                            </div>
                    </div>
                    <div class="card-body">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $ambildata = mysqli_query($con, "select * from kom_jadwal_kegiatan");
                                            while($data=mysqli_fetch_array($ambildata)){
                                                $i=1;
                                                $tahun_akademik   = $data['tahun_akademik'];
                                                $tgl_mulai_akhir  = $data['tgl_mulai_akhir'];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-succes">EDIT</button>
                                            </td>
                                        </tr>
                                        <?php        
                                            };
